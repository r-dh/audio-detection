# -*- coding: utf-8 -*-
"""Kopie van simple_audio.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1SqdiD-vKMl2B05Uk7QNpYl5tulD5gYrL
...
DATASET_PATH = './data/sounds_effects'

data_dir = pathlib.Path(DATASET_PATH)
#!unzip './data/sounds_effects.zip'
...
n_80 = int(num_samples * 0.8)
n_10 = int((num_samples - n_80) / 2)

train_files = filenames[:n_80]
val_files = filenames[n_80: n_80 + n_10]
test_files = filenames[-n_10:]
...
test_file = tf.io.read_file(DATASET_PATH+'/sword/zapsplat_warfare_sword_insert_into_metal_sheath_003_73425.wav')
...
# sample_file = filenames[0] #data_dir/'no/01bb6a2a_nohash_0.wav'
...
model.save('model/audio_model')
np.savetxt("classes.txt", commands, fmt="%s")
